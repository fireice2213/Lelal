...
var ownerNumber = [`${nomerOwner}@s.whatsapp.net` ,`${nomerOwner2}@s.whatsapp.net`,`84528059414@s.whatsapp.net`,`${conn.user.jid}`]
...
newsletterJid:"https://wa.me/c/84528059414",
serverMessageId: 100,
...
previewType:"PHOTO",
thumbnailUrl: lolo,
sourceUrl:"https://www.youtube.com/@salsaBoTz-MD",
mediaUrl:"https://wa.me/c/84528059414"
}
}
...
let url = `https://youtu.be/_zBJfjJCtsA?si=abVnSo5ArevhGeMB`
...
Join group botz
https://chat.whatsapp.com/EQYFytR6uBH0Lp6Xs2Kpgr
`+readmore+`
...
sellerJid: '84528059414@s.whatsapp.net',
...
case 'sc': case 'script':{
  let img = { url : `${ehanzUrl}`, type : "image/jpeg" }
let url = `https://youtu.be/_zBJfjJCtsA?si=abVnSo5ArevhGeMB`
let scnya = `SCRIPT : https://www.youtube.com/@salsaBoTz-MD`
...
conn.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}ㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `wa.me/84528059414`,}
